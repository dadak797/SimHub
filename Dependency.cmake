...
if(EMSCRIPTEN)
    ...
    set_target_properties(${PROJECT_NAME} 
        ...
        LINK_FLAGS "-O3 -sUSE_WEBGL2=1 -sFULL_ES3=1 -sUSE_FREETYPE=1 -sUSE_GLFW=3 -s USE_ZLIB=1 -sWASM=1 -sALLOW_MEMORY_GROWTH=1 -sNO_EXIT_RUNTIME=1 -sLLD_REPORT_UNDEFINED=1 -sERROR_ON_UNDEFINED_SYMBOLS=0 --shell-file ${CMAKE_SOURCE_DIR}/shell_minimal.html --preload-file ${CMAKE_SOURCE_DIR}@/"
    )
else()
